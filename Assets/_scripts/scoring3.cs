...
public class scoring3 : MonoBehaviour {
	...
	void OnTriggerEnter(Collider otherGameObject)
	{
		...
		if (otherGameObject.tag == "element4") {
			Destroy (element4);
		...
		if (otherGameObject.tag == "element5") {
			Destroy (element5);
		...
		if (otherGameObject.tag == "element6") {
			Destroy (element6);
		...
		if (otherGameObject.tag == "element7") {
			Destroy (element7);
